                                        ...
                                        <div class="card-body">
                                            <div class="form-group" style="margin-top: 15px;margin-right: 50px;margin-left: 50px;">
                                                ...
                                                <div><label for="snapnum" style="text-align: right;"><strong>البريد الالكتروني</strong></label>
                                                    <div style="padding-bottom: 22px;">
                                                    <input type="email" name="email" value="{{ $user->email }}" class="form-control" disabled></div>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <a href="{{route('profile.edit', $user)}}" class="btn btn-sm btnprofil" type="submit">تحديث البيانات</a></div>
                                                    </div>
                                            </div>
                                        </div>
                                        </form>
