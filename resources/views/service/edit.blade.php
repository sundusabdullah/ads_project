...
<div class="row "> 
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('service.update', $service) }}" method="post" class="form">
                        @csrf
                        @method('PATCH')
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <input name="services_name" type="text" class="form-control" value="{{ $service->services_name }}" required>
                        </div>

                        <!-- service price -->
                        <div class="col-4">
                            <label for="services_price">{{__('سعر الخدمة')}}</label>
                            <input name="services_price" type="number"  value="{{ $service->services_price }}" class="form-control">
                        </div>
