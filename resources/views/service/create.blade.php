        ...
        <div class="container-fluid pb-5">
            ...
            <div class="card shadow mb-5">
                <div class="card-header py-3">
                    <p class="m-0 font-weight-bold">إضافة خدمات حساب انستجرام</p>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col col-lg-6 col-xl-6 col-12">
                                <div class="form-group" style="text-align: right;">
                                    ...
                                    <input class="form-control" type="text" name="services_instagram_name" placeholder="اسم الخدمة">
                                </div>
                            </div>
                            <div class="col col-lg-6 col-xl-6 col-12">
                                <div class="form-group" style="text-align: right;">
                                    <label for="services_instagram_price"><strong>السعر</strong><br></label>
                                    <input class="form-control" type="number" name="services_instagram_price" placeholder="0,000 SR">
            ...
            <div class="card shadow mb-5">
                <div class="card-header py-3">
                    <p class="m-0 font-weight-bold">إضافة خدمات حساب سناب شات</p>
                </div>
                <div class="card-body">
                        <div class="form-row">
                            <div class="col col-lg-6 col-xl-6 col-12">
                                <div class="form-group" style="text-align: right;"><label for="services_snapchat_name"><strong>اسم الخدمة</strong><br></label><input class="form-control" type="text" name="services_snapchat_name" placeholder="اسم الخدمة"></div>
                            </div>
                            <div class="col col-lg-6 col-xl-6 col-12">
                                <div class="form-group" style="text-align: right;">
                                    <label for="services_snapchat_price"><strong>السعر</strong><br></label>
                                    <input class="form-control" type="number" name="services_snapchat_price" placeholder="0,000 SR">
                                    <span>إذا كانت الخدمة بالتفاوض يرجى ترك الخانه فارغة</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card shadow">
                <div class="card-body">
                    <ul>
                        <li>الاسعار اعلاة بالريال السعودي.</li>
                        <li>الاسعار <strong>لا تشمل</strong> ضريبة القيمة المضافة 15%.</li>
                        <li>الاسعار <strong>لا تشمل</strong> رسوم الوكالة 15%.</li>
                    </ul>
                </div>
            </div>
        </div>
