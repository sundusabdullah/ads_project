@extends('layouts.app')
@section('content')
@section('title', 'انشاء الملف الشخصي')
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card shadow mb-5">
                                ...
                                <div class="card-body">
                                <form method="POST" action="{{ route('famous.store') }}" enctype="multipart/form-data">
                                    @csrf
                                        <div class="form-row">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col col-lg-6 col-xl-6 col-12">
                                                <div class="form-group"><label for="nationality"><strong>{{__('الجنسية')}}</strong></label>
                                                    <select class="form-control" name="nationality" data-flag="true">
                                                        <option>اختر</option>
                                                        <option >سعودي</option>
                                                        <option>كويتي</option>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div><label for="interests"><strong>{{__('الاهتمامات')}}</strong></label>
                            ...
                            <input type="text" name="interests" class="form-control"></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="col-12 form-control" placeholder="السعودية" name="region"></div>
                                    <br>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col col-lg-7">
                    <div class="card shadow">
                        ...
                        <div class="card-body sex">
                            <div class="row">
                                <div class="col col-lg-6 x"><i class="fa fa-female d-flex d-lg-flex justify-content-center align-items-center justify-content-lg-center align-items-lg-center fa-2x"></i><input type="text" class="col-12 form-control" placeholder="50%" name="female_follow"></div>
