                                    ...
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="progress mb-4" style="color: #f8f9fc;">
                                                <div class="progress-bar" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"><span class="sr-only">20%</span></div>
                                            </div>
                                                    ...
                                                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                        ...
                                                        @foreach($services_2 as $services_2)
                                                            ...
                                                            @if($services_2['services_snapchat_name'] != null)
                                                                ...
                                                                <td>تفاوض</td>
                                                                <td>
                                                                    <a type="button" class="btn"  href="{{route('fixed.create',$services_2['id'])}}" data-toggle="tooltip" data-placement="top" title="مفاوضة" style= "background:  linear-gradient(45deg, #50008c, #793aa9); color:#fff;" > 
                                                                    <i class="fa fa-handshake-o"></i></a>
                                                                </td>
                                                                @else
